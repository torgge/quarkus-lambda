...
FUNCTION_NAME=QuarkusAwsLambda
HANDLER=io.quarkus.amazon.lambda.runtime.QuarkusStreamHandler::handleRequest
RUNTIME=java11
ZIP_FILE=fileb:///Users/gbonespirito/Development/aws/lambda/quarkus-aws-lambda/target/function.zip
...
then
  RUNTIME=provided
  ZIP_FILE=fileb:///Users/gbonespirito/Development/aws/lambda/quarkus-aws-lambda/target/function.zip
  FUNCTION_NAME=QuarkusAwsLambdaNative
